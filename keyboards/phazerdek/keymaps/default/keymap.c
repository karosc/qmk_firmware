...
[BASE] = LAYOUT(  // layer 0 : default
        ...
        KC_LGUI,       KC_Z,         KC_X,     KC_C,     KC_V,        KC_B,
              ...
              TM,       KC_H,     KC_J,     KC_K,           KC_L,            TD(TD_SEMICOLON_COLON), TD(TD_QUOT), //SFT_T(KC_QUOT),  //SFT_T(TD(TD_QUOT))
                 ...
                 KC_APP ,KC_LSFT,                X(SMILE),       SNAP_L,
        WINDOWS  ,RAISE ,KC_BSPC,  KC_ENT,
        TASKVIEW,   SEL_AL
    ),
...
[_RAISE] = LAYOUT(  // layer 0 : default
        ...
        TO(GAME),       XP(SUB1,SUP1) , XP(SUB2,SUP2) , XP(SUB3,SUP3) , XP(SUB4,SUP4) , XP(SUB5,SUP5), X(SNEK),
        _______,   _______       , _______      , KC_WH_U      , _______      , _______         , _______,
        _______,   _______       , KC_WH_L      , KC_WH_D      , KC_WH_R      , _______         , _______,
        _______,   KC_ASDN       , KC_ASUP      , KC_ASRP      , KC_ASOFF     , KC_ASON         ,
                                         _______ ,    _______ ,                    _______ , _______,
                                                                   _______ ,   KC_UNDS ,  _______ ,  _______ ,
                                                                                          _______ ,  _______ ,
                        // right hand
            DYN_MACRO_PLAY1, XP(SUB6,SUP6)  , XP(SUB7,SUP7), XP(SUB8,SUP8),  XP(SUB9,SUP9), XP(SUB0,SUP0), RESET,
            DYN_REC_STOP,     X(GEQ)       , _______     , _______     ,  _______     , _______     , _______,
            DYN_REC_START1, X(ABOUT)      ,  X(PLSMIN)  , _______     ,  _______     , _______     , _______,
                     X(LEQ)       , _______     , _______     ,  _______     , _______     , _______,
             _______,  _______ ,                  _______,        _______,
  _______  ,  _______,  _______,        _______,
  _______  ,  _______
    ),
...
[_ADJUST] = LAYOUT(  // layer 0 : default
        ...
        _______,        X(SMILE), _______          , _______ , _______   , _______, _______,
        _______,        _______ , _______          , _______ , colrst , X(DEG)  , _______,
        _______,        X(ALPHA), XP(sigma, SIGMA) , X(DELTA), X(FUNC), _______ , _______,
        _______,        _______ , _______          , _______ , _______, _______ ,
                                         _______ ,    _______ ,                    _______ , _______,
                                                                   _______ ,   _______ ,  _______ ,  _______ ,
                                                                                          _______ ,  _______ ,
         ...
         _______,       _______,        _______,        _______,        X(LAMDA),       _______,         LCTL(LALT(KC_4)),
                        _______,        X(MU)  ,        _______,        _______,        _______,         LCTL(LALT(KC_5)),
               _______,   _______ ,                     _______,        _______,
  _______  ,  _______,  _______,        _______,
  _______  ,  _______
    ),
...
//MACROS
  ...
  case autoprint:
    if (record->event.pressed) {
        ...
        //snprintf(result, 8, "\n%d\n", autoclick_int);
        //char result[50];
        //sprintf(result,"%i",autoclick_int);
